...
const N500_REST = [
  ...
  {sym:'MAPMYINDIA', name:'C.E. Info Systems',     ind:'IT'},
  ...
  {sym:'EIHAOTEL',   name:'EIH Ltd (Oberoi)',      ind:'Consumer Services'},
  ...
  {sym:'GMRINFRA',   name:'GMR Infra',             ind:'Services'},
  ...
  {sym:'GSFC',       name:'Gujarat State Fertilizers', ind:'Chemicals'},
  {sym:'GSPL',       name:'Gujarat State Petronet',ind:'Oil Gas'},
  ...
  {sym:'HIMATSEIDE', name:'Himatseingka Seide',    ind:'Textiles'},
  ...
  {sym:'ISEC',       name:'ICICI Securities',      ind:'Financial Services'},
  {sym:'IIFLGLAM',   name:'IIFL Securities',       ind:'Financial Services'},
  ...
  {sym:'JSWHOLD',    name:'JSW Holdings',          ind:'Financial Services'},
  ...
  {sym:'L&TFH',      name:'L&T Finance Holdings',  ind:'Financial Services'},
  ...
  {sym:'MAHDISC',    name:'Mahindra Logistics',    ind:'Services'},
  {sym:'MAHINDCIE',  name:'Mahindra CIE Auto',     ind:'Automobile'},
  ...
  {sym:'NIPPON',     name:'Nippon Life India AMC', ind:'Financial Services'},
  ...
  {sym:'PGI',        name:'P&G Health',            ind:'Healthcare'},
  ...
  {sym:'UCOBANK',    name:'UCO Bank',              ind:'Financial Services'},
  ...
  {sym:'VANYA',      name:'Vanya Commercials',     ind:'Financial Services'},
  {sym:'VENKEYS',    name:'Venky\'s India',        ind:'FMCG'},
  {sym:'VIJAYA',     name:'Vijaya Diagnostic',     ind:'Healthcare'},
  {sym:'VINATIPORG', name:'Vinati Organics',       ind:'Chemicals'},
  {sym:'IDEA',       name:'Vodafone Idea',         ind:'Telecom'},
  {sym:'WELSPUNLIV', name:'Welspun Living',        ind:'Textiles'},
  {sym:'ZEEL',       name:'Zee Entertainment',    ind:'Consumer Services'},
  {sym:'ZYDUSWELL',  name:'Zydus Wellness',        ind:'FMCG'}
];
...
function toYF(sym) {
  const map = {
    ...
    'L&TFH':      'LTF.NS',
    'MAHDISC':    'MAHLOG.NS',
    'MAHINDCIE':  'CIEINDIA.NS',
    'NIPPON':     'NAM-INDIA.NS',
    'PGI':        'PGHL.NS',
    'VINATIPORG': 'VINATIORGA.NS',
  };
